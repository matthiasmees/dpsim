...
SystemTopology buildTopology(CommandLineArgs &args,
  ...
  // Fixed values for TGOV1 model, adjusted for dpsim implementation
  CPS::Real T4 = 1.0;
  CPS::Real T5 = 1.0;
...
int main(int argc, char *argv[]) {
  CommandLineArgs args(argc, argv, "DP_Ph1_9bus_4order", 0.00005, 0.01 * 60,
