...
#
get_filename_component(filename "/dpsim/_deps/suitesparse-module-subbuild/suitesparse-module-populate-prefix/src/SuiteSparse-release-v5.10.6.tar.gz" ABSOLUTE)
get_filename_component(directory "/dpsim/_deps/suitesparse-module-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-suitesparse-module-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-suitesparse-module-populate${i}")
