...
execute_process(
  COMMAND "/usr/sbin/git" --git-dir=.git show-ref "master"
  WORKING_DIRECTORY "/dpsim/_deps/profile-data-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/dpsim/_deps/profile-data-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/dpsim/_deps/profile-data-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
