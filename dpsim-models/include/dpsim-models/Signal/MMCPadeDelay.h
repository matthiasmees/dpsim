...
/// Multi-channel second-order Pade modulation delay.
class MMCPadeDelay final : public MMCStateSpaceBlock {
public:
  explicit MMCPadeDelay(UInt channels = 5);
  void setDelay(Real timeDelay, Bool enabled);
