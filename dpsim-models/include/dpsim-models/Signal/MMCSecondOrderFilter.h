...
/// Critically damped cascade of two identical first-order sections.
class MMCSecondOrderFilter final : public MMCStateSpaceBlock {
public:
  explicit MMCSecondOrderFilter(UInt channels = 1);
