...
/// Input: [v_q], state: [xi_pll, delta_theta],
/// output: [delta_omega, delta_theta].
class MMCSrfPll final : public MMCStateSpaceBlock {
public:
  MMCSrfPll();
  void setParameters(Real kp, Real ki, Bool enabled);
