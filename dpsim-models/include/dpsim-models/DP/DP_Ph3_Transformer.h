...
private:
  ...
  std::shared_ptr<DP::Ph3::Resistor> mSubSnubResistor1;
  /// Internal parallel resistance 2 as snubber
  std::shared_ptr<DP::Ph3::Resistor> mSubSnubResistor2;
  /// Internal parallel capacitance 1 as snubber
  std::shared_ptr<DP::Ph3::Capacitor> mSubSnubCapacitor1;
  /// Internal parallel capacitance 2 as snubber
  std::shared_ptr<DP::Ph3::Capacitor> mSubSnubCapacitor2;
