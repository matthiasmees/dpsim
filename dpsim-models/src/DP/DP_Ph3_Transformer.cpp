...
SimPowerComp<Real>::Ptr DP::Ph3::Transformer::clone(String name) {
...
void DP::Ph3::Transformer::setParameters(Real nomVoltageEnd1,
...
void DP::Ph3::Transformer::initializeFromNodesAndTerminals(Real frequency) {
  ...
  **mIntfVoltage = vInitABC.real();
  ...
  mSubSnubResistor1 =
      std::make_shared<DP::Ph3::Resistor>(**mName + "_snub_res1", mLogLevel);
  ...
  mSubSnubResistor2 =
      std::make_shared<DP::Ph3::Resistor>(**mName + "_snub_res2", mLogLevel);
  ...
  // mSubSnubCapacitor1 = std::make_shared<DP::Ph3::Capacitor>(**mName + "_snub_cap1", mLogLevel);
  ...
  mSubSnubCapacitor2 =
      std::make_shared<DP::Ph3::Capacitor>(**mName + "_snub_cap2", mLogLevel);
...
void DP::Ph3::Transformer::mnaParentInitialize(
...
void DP::Ph3::Transformer::mnaCompApplySystemMatrixStamp(
